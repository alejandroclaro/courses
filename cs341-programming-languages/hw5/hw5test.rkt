...
(define tests
  (test-suite
   ...
   (check-equal?
     (eval-exp (call (fun "f" "x" (ifgreater (var "x") (int 3) (var "x") (call (var "f") (add (int 1) (var "x"))))) (int 0)))
     (int 4)
     "call test")
   ...
   (check-equal?
     (eval-exp (call (call mupl-map (fun #f "x" (add (var "x") (int 7)))) (apair (int 2) (apair (int 1) (aunit)))))
     (apair (int 9) (apair (int 8) (aunit)))
     "mupl-map test")
