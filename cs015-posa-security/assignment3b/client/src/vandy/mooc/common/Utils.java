...
public class Utils
{
  ...
  /**
   * Return an uppercase version of the input or null if user gave no input. If
   * user gave no input and @a showToast is true a toast is displayed to this
   * effect.
   */
  ...
  /**
   * This method is used to hide a keyboard after a user has finished typing the
   * url.
   */
   ...
   * @param failureReason
   *          String to add to add as an extra to the Intent passed back to the
   *          originating Activity if the @a pathToContent is null.
   */
   ...
   * @param failureReason
   *          String to add to add as an extra to the Intent passed back to the
   *          originating Activity if the result of the Activity is
   *          RESULT_CANCELED.
   */
