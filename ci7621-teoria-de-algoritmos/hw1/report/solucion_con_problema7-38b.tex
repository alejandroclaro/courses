...
\noindent {\bf b)} Para todo entero $n > 1$, dar un algoritmo para construir un horario que permita que finalice el torneo en $n-1$ días si $n$ es par, o en $n$ días si $n$ es impar.\\
...
%  \hline
%\end{tabular}
%\caption{Una solución del problema de planificación para $n = 5$}
%\label{tab:rr5}
%\end{table}
