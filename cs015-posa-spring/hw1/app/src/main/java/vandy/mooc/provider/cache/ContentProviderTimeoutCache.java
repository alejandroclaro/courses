  ...
  implements TimeoutCache<String, List<AcronymExpansion>>
{
                        ...
                        long timeout)
  {
    ...
    for (int i = 0; i < longForms.size(); i++)
    {
      ...
      AcronymExpansion lf = longForms.get(i);

      cvs.put(AcronymContract.AcronymEntry.COLUMN_ACRONYM, acronym);
      cvs.put(AcronymContract.AcronymEntry.COLUMN_LONG_FORM, lf.getLf());
      cvs.put(AcronymContract.AcronymEntry.COLUMN_FREQUENCY, lf.getFreq());
      cvs.put(AcronymContract.AcronymEntry.COLUMN_SINCE, lf.getSince());
      cvs.put(AcronymContract.AcronymEntry.COLUMN_EXPIRATION_TIME, expirationTime);
      ...
      null))
    {
        ...
        && expiredData.moveToFirst())
      {
        do
        {
          ...
          final String deleteLocation = expiredData.getString(expiredData.getColumnIndex(AcronymEntry.COLUMN_ACRONYM));
